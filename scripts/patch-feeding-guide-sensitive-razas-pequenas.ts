/**
 * NUPEC – Patch: Guía de Alimentación "Sensitive Razas Pequeñas" (canino)
 *
 * El documento (id feedingguide-canino-sensitive-razas-pequenas) ya tenía
 * las 8 filas correctas (weightRange/dailyAmount, coinciden con la ficha
 * técnica) pero:
 ...
 *
 * Cada fila ya es un rango de peso (ej. "5 – 7 kg" -> 120–150 g), así que
 ...
 *
 * Uso:
 *   npx tsx scripts/patch-feeding-guide-sensitive-razas-pequenas.ts
 *
...
const FEEDING_GUIDE_ID = "feedingguide-canino-sensitive-razas-pequenas";

type RangeRow = { weightMin: number; weightMax: number; amountMin: number; amountMax: number; cups: string };

const RANGES: RangeRow[] = [
  { weightMin: 1, weightMax: 2, amountMin: 40, amountMax: 60, cups: "1/3 a 2/3" },
  { weightMin: 2, weightMax: 3, amountMin: 60, amountMax: 80, cups: "2/3 a 3/4" },
  { weightMin: 3, weightMax: 4, amountMin: 80, amountMax: 100, cups: "3/4 a 1" },
  { weightMin: 4, weightMax: 5, amountMin: 100, amountMax: 120, cups: "1 a 1 1/4" },
  { weightMin: 5, weightMax: 7, amountMin: 120, amountMax: 150, cups: "1 1/4 a 1 1/3" },
  { weightMin: 7, weightMax: 10, amountMin: 150, amountMax: 190, cups: "1 1/3 a 1 3/4" },
  { weightMin: 10, weightMax: 12, amountMin: 190, amountMax: 210, cups: "1 3/4 a 2" },
  { weightMin: 12, weightMax: 15, amountMin: 210, amountMax: 250, cups: "2 a 2 1/4" },
];
