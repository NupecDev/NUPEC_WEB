/**
 * NUPEC – Patch: Guía de Alimentación "Felino Hypoallergenic" (felino)
 *
 * El documento (id feedingguide-felino-hypoallergenic) tenía las 3
 * condiciones corporales (Delgado / Normal / Sobrepeso) MEZCLADAS en una
 * sola fila de texto por peso (dailyAmount concatenaba los 3 valores), con
 * _type: "row" (no "feedingRow") y sin weightMin/weightMax/amountMin/
 * amountMax.
 *
 ...
 *
 * Uso:
 *   npx tsx scripts/patch-feeding-guide-felino-hypoallergenic.ts
 *
...
const FEEDING_GUIDE_ID = "feedingguide-felino-hypoallergenic";

type Point = { weight: number; grams: number; cups: string };

const NORMAL: Point[] = [
  { weight: 2, grams: 41, cups: "2/5" },
  { weight: 3, grams: 56, cups: "3/5" },
  { weight: 4, grams: 70, cups: "3/4" },
  { weight: 5, grams: 81, cups: "4/5" },
  { weight: 6, grams: 94, cups: "1" },
];

const DELGADO: Point[] = [
  { weight: 2, grams: 47, cups: "1/2" },
  { weight: 3, grams: 65, cups: "2/3" },
  { weight: 4, grams: 80, cups: "4/5" },
  { weight: 5, grams: 93, cups: "1" },
  { weight: 6, grams: 108, cups: "1 1/5" },
];

const SOBREPESO: Point[] = [
  { weight: 2, grams: 35, cups: "1/3" },
  { weight: 3, grams: 48, cups: "1/2" },
  { weight: 4, grams: 59, cups: "3/5" },
  { weight: 5, grams: 69, cups: "3/4" },
  { weight: 6, grams: 80, cups: "4/5" },
];
