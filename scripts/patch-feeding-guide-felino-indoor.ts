/**
 * NUPEC – Patch: Guía de Alimentación "Felino Indoor" (felino)
 *
 * El documento (id 623709c0-73f9-47a6-9e5f-5e3add7b340b) solo tenía la
 * tabla agrupada estática (secondaryTableRows: Sedentarios/Activos/Muy
 * Activos x tallas Pequeño/Mediano/Grande = 2/4/6.5 kg) — sin `rows`
 ...
 *
 * Uso:
 *   npx tsx scripts/patch-feeding-guide-felino-indoor.ts
 *
...
const FEEDING_GUIDE_ID = "623709c0-73f9-47a6-9e5f-5e3add7b340b";
