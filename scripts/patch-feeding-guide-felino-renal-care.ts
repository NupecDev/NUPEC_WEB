/**
 * NUPEC – Patch: Guía de Alimentación "Felino Renal Care" (felino)
 *
 * El documento (id ba68b6f1-6100-497e-b283-0056b46b8e85) solo tenía la
 ...
 *
 * Uso:
 *   npx tsx scripts/patch-feeding-guide-felino-renal-care.ts
 *
...
const FEEDING_GUIDE_ID = "ba68b6f1-6100-497e-b283-0056b46b8e85";

type Point = { weight: number; grams: number; cups: string };

const NORMAL: Point[] = [
  { weight: 2, grams: 32, cups: "1/3" },
  { weight: 3, grams: 47, cups: "1/2" },
  { weight: 4, grams: 63, cups: "2/3" },
  { weight: 5, grams: 79, cups: "4/5" },
  { weight: 6, grams: 95, cups: "1" },
  { weight: 6.5, grams: 103, cups: "1 1/5" },
];

const DELGADA: Point[] = [
  { weight: 2, grams: 62, cups: "2/3" },
  { weight: 3, grams: 84, cups: "4/5" },
  { weight: 4, grams: 104, cups: "1" },
  { weight: 5, grams: 123, cups: "1 1/4" },
  { weight: 6, grams: 141, cups: "1 1/2" },
  { weight: 6.5, grams: 150, cups: "1 3/5" },
];
...
const notes = {
  es: "Para gatos adultos a partir de 1 año de edad. Un vaso de 225 ml (8 oz) = 94 g de NUPEC® FELINO RENAL CARE.",
  en: "",
  fr: "",
};
