...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "array",
      group: "contenido",
      description: "Preguntas y respuestas específicas del producto, expuestas como datos estructurados FAQPage (mejora respuestas en ChatGPT, Perplexity, AI Overviews).",
      of: [
        {
          type: "object",
          name: "faqItem",
    ...
    defineField({
      ...
      options: {
        list: [
          ...
          { title: "Salud articular", value: "articular" },
          { title: "Cuidado cardiaco", value: "cardiaco" },
          { title: "Cuidado hepático", value: "hepatico" },
          { title: "Manejo de alergias alimentarias", value: "alergias" },
          { title: "Salud dental", value: "dental" },
          { title: "Manejo de ansiedad y estrés", value: "ansiedad" },
          { title: "Función cognitiva", value: "cognitivo" },
          { title: "Vitalidad y energía", value: "vitalidad" },
        ],
        layout: "grid",
      },
    }),
