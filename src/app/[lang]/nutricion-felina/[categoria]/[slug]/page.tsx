...
export async function generateMetadata({
  ...
  return buildMetadata({
    ...
    pathWithoutLocale: `/nutricion-felina/${categoria}/${slug}`,
    seo: product.seo,
...
export default async function ProductPage({
  ...
  const productUrl = localizedUrl(`/nutricion-felina/${categoria}/${slug}`, lang as Locale);
  const jsonLd = [
    productJsonLd({
      name: product.name,
    ...
    breadcrumbJsonLd([
      ...
      { name: product.category.name, url: localizedUrl(`/nutricion-felina/${categoria}`, lang as Locale) },
  ...
  if (isClinical) {
    return (
      <PageLayout accentColor={accentColor}>
        {jsonLdScript}
        {/* 1. Hero */}
        <ProductHero product={{ ...product, species: 'felino' }} />
...
accentColor={accentColor}
      ...
      <ProductFeedingGuide feedingGuide={product.feedingGuide} accentColor={accentColor} species="felino" />
