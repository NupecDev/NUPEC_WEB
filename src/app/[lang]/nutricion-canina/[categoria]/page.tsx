...
export async function generateMetadata({
  ...
  return buildMetadata({
    ...
    pathWithoutLocale: `/nutricion-canina/${categoria}`,
    seo: category.seo,
    fallbackTitle: `${category.name} para perros`,
...
export default async function CategoryPage({
  ...
  const jsonLd = [
    breadcrumbJsonLd([
      ...
      { name: category.name, url: localizedUrl(`/nutricion-canina/${categoria}`, lang as Locale) },
    ]),
    faqJsonLd(
      (category.faq ?? [])
