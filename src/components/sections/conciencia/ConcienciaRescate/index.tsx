...
export default function ConcienciaRescate() {
  const t = useTranslations('conciencia.rescate');

  return (
    /* Split section como ConcienciaTerapias: texto izquierda / imagen derecha. */
