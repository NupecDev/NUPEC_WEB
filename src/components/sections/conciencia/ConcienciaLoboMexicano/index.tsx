...
export default function ConcienciaLoboMexicano() {
  const t = useTranslations('conciencia.loboMexicano');

  return (
    /* Split section invertido: imagen izquierda / texto derecha, para alternar con la sección anterior. */
